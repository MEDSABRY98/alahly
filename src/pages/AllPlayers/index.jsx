...
import { Filter, Calendar, CalendarDays, RefreshCw, Search, Users } from 'lucide-react';
...
export default function AllPlayers() {
  ...
  const PlayerRow = React.memo(({ player, stats }) => {
    ...
    if (stats) {
      // Define the same order as the table headers
      const statOrder = [
    ...
    <div className="all-players-page">
      <div className="page-header">
        ...
        <button
          ...
          title="Sync data and refresh cache"
        >
          ...
          <table className="all-players-table">
            <thead>
              <tr>
                ...
                {/* Static headers - we know the order from playerStatsCalculator */}
