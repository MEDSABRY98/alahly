...
import { Filter, Calendar, CalendarDays, RefreshCw, Search, ChevronUp, ChevronDown, TrendingUp, Trophy, Users, Clock, Target, Zap, Award, CornerUpRight, AlertTriangle } from 'lucide-react';
...
export default function PlayerStats() {
  ...
  }, [playerSearch, selectedPlayerTeams, calculatePlayerStats, filterSeason, filterChampion, filterStad, filterChampionSystem, filterManager, filterManagerOpp, filterRef, filterHAN, filterTeamOpp, filterWDL, dateFrom, dateTo]);
        ...
        <div className="vs-gk-tab">
          <div className="no-data-message">
            <div className="no-data-content">
              ...
              <p>Please select a player to view goalkeepers who conceded goals from them</p>
            </div>
          </div>
        </div>
      );
    ...
    <div className="player-stats">
      <div className="page-header">
        ...
        <button
          ...
          title="Sync player statistics data"
        >
          <RefreshCw 
